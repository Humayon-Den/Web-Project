  ...
  return (
    <div className="h-[10vh] w-full bg-[#2B2E36]  text-white fixed">
      ...
      <Image src={"/twitter.png"}  width={20} height={20} /> */}
        ...
        <div className="bg-[#40424A] ml-[200px] border border-solid border-[#414550] rounded-full pr-[30px] p-[7px] flex items-center">
        ...
        <div className="bg-[#40424A]  border border-solid border-[#414550] rounded-full ml-[10px] p-[5px] text-white stroke-white fill-white">
          <Image src={"/reddit-logo.png"} width={25} height={20} alt="social" />
        </div>
        ...
        <div className="h-[40px] w-[2px] ml-14 bg-gray-500"></div>

        <div className="bg-[#40424A]  border border-solid border-[#414550] rounded-full ml-[40px] p-[7px] text-white stroke-white fill-white">
